...
window.onload=function(){
	...
	data:{
	      ...
	      userpass:'',
	      yanzhengma:'',
	      yanzhen:'http://192.168.1.105/check_code',
	      username1:'',
	...
	methods:{
       ...
       show(level,act,page){
              if(act==1){
              	this.flag=1;
       	      this.activity=[];
       	      this.$http.get('http://192.168.1.105/show_activities',
       		     {a_level:level,
       		     current_page:page}
       		     ).then((res)=>{
					  ...
					  a_id:st[i].a_id
       					...
       					alert("请求数据失败！！！")
                                   ...
                                   this.flag=2;
       				this.activity=[],
       				this.$http.get('http://192.168.1.105/show_teams',
            ...
            this.$http.post('http://192.168.1.105/login', {
              ...
              $("#mark1").css('display', 'block');
               $("#form1").css('display', 'block');
                     ...
                     check_login(){
                            ...
                            this.$http.get('http://192.168.1.105/check_login',{}).then((res)=>{
                                   var st=res.data;
